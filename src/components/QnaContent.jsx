...
export default function QnaContent({ id, data, relatedQuestions, lang }) {
  ...
  const editorNote = lang === "en" ? data.editor_note_en : data.editor_note_kn;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-md border border-white/40 p-8">
          {/* IMAGE SECTION */}
          ...
          {/* FIqh Badge */}
          <div className="mb-3">
            <span className="inline-block border bg-blue-50 text-blue-600 border border-blue-100 text-xs font-semibold px-3 py-1 rounded-full tracking-wide">
              Shafi‘i Fiqh
            </span>
          </div>
            ...
            {hasAttribution ? (
              ...
              <>
                {lang === "en" ? (
                  <>
                    <p>
                      The answers published on this platform are sourced from
                      the official archives of Al Ansar Weekly, an Islamic
                      weekly in continuous publication since 1991.
                    </p>
                    <p>
                      These responses were originally issued in print under the
                      editorial supervision of Tajul Fuqah Bekal Ibrahim
                      Musliyar and S.P. Hamza Saqafi, and are now being
                      presented in digital format to ensure wider accessibility
                      while preserving their scholarly authenticity.
                    </p>
                    <p>
                      Some English answers are translated from Keli Nodi section
                      of Alansar Weekly.
                    </p>
                  </>
                ) : (
                  <>
                    <p>
                      ಈ ವೆಬ್‌ಸೈಟ್‌ನಲ್ಲಿ ಪ್ರಕಟವಾಗುವ ಉತ್ತರಗಳು Al Ansar Weekly
                      ಪತ್ರಿಕೆಯ ಅಧಿಕೃತ ಆರ್ಕೈವ್‌ಗಳಿಂದ ಸಂಗ್ರಹಿಸಲ್ಪಟ್ಟಿವೆ.
                    </p>
                    <p>
                      ಮೂಲತಃ ಮುದ್ರಿತ ಆವೃತ್ತಿಯಲ್ಲಿ Tajul Fuqah Bekal Ibrahim
                      Musliyar ಹಾಗೂ S.P. Hamza Saqafi ಅವರ ಸಂಪಾದಕೀಯ
                      ಮೇಲ್ವಿಚಾರಣೆಯಡಿ ಪ್ರಕಟಗೊಂಡವು.
                    </p>
                  </>
                )}
              </>
          ...
          <div className="mt-10 pt-6 border-t">
            <div className="bg-blue-50 border-blue-100 rounded-xl p-5 text-center">
