...
const ArticleCard = ({ article }) => {
  ...
  const { _id, title, image, author, date, excerpt, category, isFeatured } =
    article;
  ...
  return (
    <div className="relative bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 w-[320px] overflow-hidden group">
      ...
      <div className="relative h-[60%] min-h-[180px] max-h-[200px] overflow-hidden">
        ...
        <div className="absolute bottom-3 right-3 z-20">
          <Link
            ...
            className="px-5 py-2 rounded-full bg-[#0B4C8C] text-white shadow-lg font-medium text-sm flex items-center gap-2 transition-transform duration-300 hover:scale-105 active:scale-95 hover:shadow-xl"
          >
            Read Article
            <svg
      ...
      <div className="p-5 pt-8">
        ...
        <Link
          href={articleLink}
          className="inline-block active:scale-[0.99] transition-transform"
        >
