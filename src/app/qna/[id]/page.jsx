...
export async function generateMetadata(props) {
  ...
  const shortenedQuestion =
    rawQuestion.length > 60 ? rawQuestion.slice(0, 57) + "..." : rawQuestion;
  ...
  const description = rawAnswer.replace(/\s+/g, " ").trim().slice(0, 155);

  const base =
    process.env.NEXT_PUBLIC_SITE_URL || "https://www.alansarweekly.com";
